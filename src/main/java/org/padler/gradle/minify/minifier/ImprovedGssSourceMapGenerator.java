...
public final class ImprovedGssSourceMapGenerator implements GssSourceMapGenerator {
     ...
     * @param filename             used for source file name mapping
     */
    public ImprovedGssSourceMapGenerator(SourceMapDetailLevel sourceMapDetailLevel, String filename) {
        ...
        ImprovedGssSourceMapGenerator.filename = filename;
